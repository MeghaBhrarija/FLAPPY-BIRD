...
BACKGROUND1 = 'gallery/sprites/background1.png'
BACKGROUND2 = 'gallery/sprites/background2.png'
BACKGROUND3 = 'gallery/sprites/background3.png'
BACKGROUND4 = 'gallery/sprites/background4.jpg'
...
def mainGame():
    ...
    while True:
        ...
        if (score%81<=20):
            SCREEN.blit(GAME_SPRITES['background1'], (0, 0))
        if(score%81>20 and score%81<=40):
            SCREEN.blit(GAME_SPRITES['background2'], (0, 0))
        if(score%81>40 and score%81<=60):
            SCREEN.blit(GAME_SPRITES['background3'], (0, 0))
        if(score%81>60 and score%81<=80):
            SCREEN.blit(GAME_SPRITES['background4'], (0, 0))
        for upperPipe, lowerPipe in zip(upperPipes, lowerPipes):
...
def isCollide(playerx, playery, upperPipes, lowerPipes):
    if playery> GROUNDY - 31  or playery<0:
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Samarpan')
    ...
    GAME_SPRITES['background4'] = pygame.image.load(BACKGROUND4).convert()
